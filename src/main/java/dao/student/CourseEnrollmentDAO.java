...
public class CourseEnrollmentDAO {
   ...
   public List<Course> getEnrolledCoursesByUserID(String userID) {
    ...
    String sql = "SELECT c.courseID, c.title, c.description, c.fee, c.duration, c.imageUrl, " +
                 "c.startDate, c.endDate, c.isActive, ce.enrollmentDate " +
    ...
    // Check if user is enrolled in a course (using userID instead of studentID)
