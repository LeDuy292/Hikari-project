...
@WebServlet(name = "ForumServlet", urlPatterns = {"/forum", "/forum/createPost", "/forum/post/*"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pathInfo != null && pathInfo.matches("/\\d+")) {
                ...
                LOGGER.info("Forwarding to /view/postDetail.jsp for post ID: " + postId);
                ...
                List<ForumPost> posts = postDAO.getPostsSortedAndFiltered(sort, filter, page, size);
                List<UserActivityScore> topUsers = scoreDAO.getTopUsers(5);
                ...
                LOGGER.info("Forwarding to /view/forum.jsp");
