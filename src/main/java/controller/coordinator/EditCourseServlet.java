...
public class EditCourseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Handle image upload - keep existing image if no new image uploaded
            String imageUrl = "";
            CourseDAO dao = new CourseDAO();
            ...
            // Create Course object without dates
            ...
            // Update course using new method
            dao.updateCourseNew(course);
    ...
    @Override
    public String getServletInfo() {
        return "Servlet for editing course without date fields";
    }
}