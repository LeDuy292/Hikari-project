...
@WebServlet("/admin/admin-notifications")
public class AdminNotificationController extends HttpServlet {
    ...
    private final Gson gson = new GsonBuilder()
            ...
            .create();
    private static final java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger(AdminNotificationController.class.getName());
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        LOGGER.log(java.util.logging.Level.SEVERE, "Error in AdminNotificationController", e);
    ...
    private void handleGetUnreadCount(HttpServletRequest req, HttpServletResponse resp, UserAccount user) throws Exception {
        // Get notifications for admin or "Tất cả"
        List<Notification> notifications = notificationService.getNotificationsForUser("Quản trị viên");
