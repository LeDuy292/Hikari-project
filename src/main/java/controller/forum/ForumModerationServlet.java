    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pathInfo == null || pathInfo.equals("/")) {
                ...
                List<ForumPost> recentPosts = postDAO.getRecentPostsForModeration(20);
                request.setAttribute("recentPosts", recentPosts);
                request.setAttribute("user", user);
                request.getRequestDispatcher("/view/forum/moderation.jsp").forward(request, response);
                ...
                request.setAttribute("user", user);
                request.getRequestDispatcher("/view/forum/moderatePost.jsp").forward(request, response);
            }
