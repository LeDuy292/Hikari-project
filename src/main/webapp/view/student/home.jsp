                        ...
                        <div class="content-wrapper">
                                ...
                                <div class="hero-content">
                                    <div class="hero-text">
                                        ...
                                        <div class="hero-buttons">
                                            <a class="btn-primary" href="${pageContext.request.contextPath}/courseInfo">
                                                <i class="fas fa-play"></i>
                                                Bắt đầu học ngay
                                            </a>
                                            <a class="btn-secondary" href="${pageContext.request.contextPath}/courseInfo">
                                    ...
                                    <div class="hero-image">
                                        <div class="hero-card">
                                            <img src="${pageContext.request.contextPath}/assets/img/img_student/course.jpg"
                                                alt="Học tiếng Nhật" class="hero-img">
                            ...
                            <section class="features-section">
                                ...
                                <div class="features-grid">
                                    <div class="feature-card" data-aos="fade-up" data-aos-delay="100">
                                        ...
                                        <p class="feature-description">Đội ngũ giảng viên người Nhật và Việt Nam có kinh
                                            nghiệm giảng dạy lâu năm</p>
                                    </div>
                                    <div class="feature-card" data-aos="fade-up" data-aos-delay="200">
                                        ...
                                        <p class="feature-description">Học mọi lúc, mọi nơi với nền tảng học trực tuyến hiện
                                            đại và thân thiện</p>
                                    </div>
                                    ...
                                    <div class="feature-card" data-aos="fade-up" data-aos-delay="600">
                                        ...
                                        <p class="feature-description">Hệ thống theo dõi học tập chi tiết giúp bạn nắm rõ
                                            tiến độ và kết quả học tập</p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="courses-section">
                                ...
                                <div class="courses-grid">
                                    <div class="course-card" data-aos="fade-up" data-aos-delay="100">
                                        <div class="course-image">
                                            <img src="${pageContext.request.contextPath}/assets/img/courses/Japanese-N5.jpg"
                                                alt="Khóa học N5">
                                            <div class="course-level">N5</div>
                                        </div>
                                        <div class="course-content">
                                            <h3 class="course-title">Tiếng Nhật cơ bản N5</h3>
                                            <p class="course-description">Khóa học dành cho người mới bắt đầu, học từ con số
                                                0</p>
                                            <div class="course-meta">
                                                <span class="course-duration"><i class="fas fa-clock"></i> 3 tháng</span>
                                                <span class="course-students"><i class="fas fa-users"></i> 1,234 học
                                                    viên</span>
                                            </div>
                                    ...
                                    <div class="course-card" data-aos="fade-up" data-aos-delay="200">
                                        <div class="course-image">
                                            <img src="${pageContext.request.contextPath}/assets/img/courses/Japanese-N4.jpg"
                                                alt="Khóa học N4">
                                            <div class="course-level">N4</div>
                                        </div>
                                        <div class="course-content">
                                            <h3 class="course-title">Tiếng Nhật trung cấp N4</h3>
                                            <p class="course-description">Nâng cao kỹ năng giao tiếp và ngữ pháp tiếng Nhật
                                            </p>
                                            <div class="course-meta">
                                                <span class="course-duration"><i class="fas fa-clock"></i> 4 tháng</span>
                                                <span class="course-students"><i class="fas fa-users"></i> 856 học
                                                    viên</span>
                                            </div>
                                            <div class="course-price">
                                    ...
                                    <div class="course-card" data-aos="fade-up" data-aos-delay="300">
                                        <div class="course-image">
                                            <img src="${pageContext.request.contextPath}/assets/img/courses/Japanese-N3.png"
                                                alt="Khóa học N3">
                                            <div class="course-level">N3</div>
                                        </div>
                                        <div class="course-content">
                                            <h3 class="course-title">Tiếng Nhật nâng cao N3</h3>
                                            <p class="course-description">Chuẩn bị cho kỳ thi JLPT N3 với độ chính xác cao
                                            </p>
                                            <div class="course-meta">
                                                <span class="course-duration"><i class="fas fa-clock"></i> 5 tháng</span>
                                                <span class="course-students"><i class="fas fa-users"></i> 642 học
                                                    viên</span>
                                            </div>
                                            <div class="course-price">
                                ...
                                <div class="section-footer">
                                    <a class="btn-outline" href="${pageContext.request.contextPath}/courseInfo">
                                        Xem tất cả khóa học
                                ...
                                <div class="testimonials-grid">
                                    <div class="testimonial-card" data-aos="fade-up" data-aos-delay="100">
                                        <div class="testimonial-content">
                                            ...
                                            <p class="testimonial-text">"Tôi đã học được rất nhiều từ HIKARI JAPAN. Phương
                                                pháp giảng dạy rất dễ hiểu và thực tế. Sau 6 tháng học, tôi đã có thể giao
                                                tiếp cơ bản bằng tiếng Nhật."</p>
                                        </div>
                                    ...
                                    <div class="testimonial-card" data-aos="fade-up" data-aos-delay="200">
                                        <div class="testimonial-content">
                                            ...
                                            <p class="testimonial-text">"Giảng viên rất nhiệt tình và chuyên nghiệp. Tài
                                                liệu học tập phong phú và được cập nhật thường xuyên. Tôi rất hài lòng với
                                                chất lượng giảng dạy."</p>
                                        </div>
                                        <div class="testimonial-author">
                                            <div class="author-avatar">
                                                <img src="${pageContext.request.contextPath}/assets/img/img_student/study.jpg"
                                    ...
                                    <div class="testimonial-card" data-aos="fade-up" data-aos-delay="300">
                                        <div class="testimonial-content">
                                            ...
                                            <p class="testimonial-text">"Nền tảng học trực tuyến rất tiện lợi, tôi có thể
                                                học mọi lúc mọi nơi. Hệ thống bài tập và kiểm tra giúp tôi theo dõi tiến độ
                                                học tập một cách hiệu quả."</p>
                                        </div>
                                        <div class="testimonial-author">
                                            <div class="author-avatar">
                                                <img src="${pageContext.request.contextPath}/assets/img/img_student/study.jpg"
                            ...
                            <section class="cta-section">
                                <div class="cta-content">
                                    ...
                                    <p class="cta-description">Tham gia cùng hàng nghìn học viên đã thành công với HIKARI
                                        JAPAN</p>
                                    <div class="cta-buttons">
                                        <a class="btn-primary" href="${pageContext.request.contextPath}/loginPage">
                                            <i class="fas fa-rocket"></i>
                                            Đăng ký ngay
                                        </a>
                                        <a class="btn-outline" href="${pageContext.request.contextPath}/view/student/contact.jsp">
