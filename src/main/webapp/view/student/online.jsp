                      ...
                      <c:otherwise>
                          ...
                          <c:forEach var="course" items="${courses}" begin="${startIndex}" end="${endIndex}">
                              <div class="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                  <a href="${pageContext.request.contextPath}/courses?action=detail&id=${course.courseNum}">
                                  ...
                                  <div class="p-5">
                                      <h3 class="text-xl font-bold text-gray-800 mb-2">
                                          <a href="${pageContext.request.contextPath}/courses?action=detail&id=${course.courseNum}" class="hover:text-orange-600">${course.title}</a>
                                      </h3>
                                      ...
                                      <div class="flex justify-between items-center">
                                          <a href="${pageContext.request.contextPath}/courseInfo?id=${course.courseNum}" class="text-orange-500 hover:underline font-semibold">Xem chi tiết</a>
