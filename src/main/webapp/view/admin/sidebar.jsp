...
<div class="sidebar">
  <div class="sidebar-top">
    ...
    <a href="dashboard.jsp" class="sidebar-nav-item <%= currentPage.equals("dashboard.jsp") ? "active" : "" %>">
      <i class="fas fa-chart-line"></i>
      <span>Dashboard</span>
    </a>
    <a href="manageUsers.jsp" class="sidebar-nav-item <%= currentPage.equals("manageUsers.jsp") ? "active" : "" %>">
      <i class="fas fa-users"></i>
      <span>Quản Lý Tài Khoản</span>
    </a>
    <a href="manageCourses.jsp" class="sidebar-nav-item <%= currentPage.equals("manageCourses.jsp") ? "active" : "" %>">
      <i class="fas fa-book"></i>
      <span>Quản Lý Khóa Học</span>
    </a>
    <a href="managePayments.jsp" class="sidebar-nav-item <%= currentPage.equals("managePayments.jsp") ? "active" : "" %>">
      <i class="fas fa-credit-card"></i>
      <span>Quản Lý Thanh Toán</span>
    </a>
    <a href="manageReviews.jsp" class="sidebar-nav-item <%= currentPage.equals("manageReviews.jsp") ? "active" : "" %>">
      <i class="fas fa-star"></i>
      <span>Quản Lý Đánh Giá</span>
    </a>
    <a href="manageNotifications.jsp" class="sidebar-nav-item <%= currentPage.equals("manageNotifications.jsp") ? "active" : "" %>">
