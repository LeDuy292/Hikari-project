                                ...
                                <tbody>
                                    <c:forEach var="cv" items="${cvList}">
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-${cv.interviewStatus == 'Pass' ? 'success' : cv.interviewStatus == 'Fail' ? 'danger' : 'warning'}">
                                                    ${cv.interviewStatus == 'Pass' ? 'Đạt' : cv.interviewStatus == 'Fail' ? 'Chưa đạt' : 'Chưa phỏng vấn'}
                                                </span>
                                            </td>
                                            <td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="${pageContext.request.contextPath}/cv" method="post">
                                                ...
                                                <input type="hidden" name="interview-status" value="pending">
                                                ...
                                                <div class="mb-3">
                                                    <label for="status${cv.cvID}" class="form-label">Trạng thái</label>
                                                    <select name="interviewStatus" id="status${cv.cvID}" class="form-select form-select-sm" required">
                                                        <option value="Pending" ${cv.interviewStatus == 'Pending' ? 'selected' : ''}>Chưa phỏng vấn</option>
                                                        <option value="Pass" ${cv.interviewStatus == 'Pass' ? 'selected' : ''}>Đạt</option>
                                                        <option value="Fail" ${cv.interviewStatus == 'Fail' ? 'selected' : ''}>Chưa đạt</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
