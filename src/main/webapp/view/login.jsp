    ...
    <body>
        ...
        <div class="auth-wrapper">
            ...
            <div class="auth-side">
                ...
                <div class="stats">
                    <div class="stat">
                        +2000<br /><span style="font-size: 0.9em; font-weight: 400">Từ vựng</span>
                    </div>
                    <div class="stat">
                        +100<br /><span style="font-size: 0.9em; font-weight: 400">Bài học</span>
                    </div>
                    <div class="stat">
            ...
            <div class="auth-form-section">
                <div class="auth-form-container">
                    <% 
                      ...
                      if (success != null && success.contains("Mật khẩu đã được cập nhật")) {
                          success = "Mật khẩu của bạn đã được đặt lại thành công. Vui lòng đăng nhập với mật khẩu mới.";
                      }
                    %>
                    ...
                    <% } %>
                    <form id="authForm" action="<%= request.getContextPath() %>/login" method="post">
