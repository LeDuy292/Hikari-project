...
<html lang="vi">
    <head>
        ...
        <title>Tạo bài test mới - HIKARI Japanese</title>
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <div class="header-actions">
                    <a href="manageTests" class="btn btn-outline">
            ...
            <div class="form-container">
                <form method="POST" action="${pageContext.request.contextPath}/taskTest" class="test-form" id="createTestForm" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="title" class="form-label">Tên bài test *</label>
                                <input type="text" id="title" name="title" class="form-control" required 
                                       placeholder="Nhập tên bài test..." value="${test.title}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control" rows="4" 
                                      placeholder="Mô tả về nội dung và mục đích của bài test...">${test.description}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="jlptLevelInfo" class="form-label">JLPT Level</label>
                                <input type="text" id="jlptLevelInfo" class="form-control" value="${jlptLevel}" readonly>
                            </div>

                            <div class="form-group">
                                <label for="duration" class="form-label">Thời gian làm bài *</label>
                                <div class="duration-input-group">
                                    <input type="number" id="duration" name="duration" class="form-control" 
                                           min="5" max="180" step="5" value="60" required>
                                    <span class="duration-unit">phút</span>
                                </div>
                                <small class="form-text text-muted">Thời gian từ 5 đến 180 phút</small>
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group">
                                <label for="totalMark" class="form-label">Tổng điểm</label>
                                <input type="number" id="totalMark" name="totalMark" class="form-control" 
                                       min="0" max="100" step="0.5" value="100" readonly>
                            </div>

                            <div class="form-group">
                                <label for="totalQuestions" class="form-label">Số câu hỏi</label>
                                <input type="number" id="totalQuestions" name="totalQuestions" class="form-control" 
                                       min="1" max="100" value="0" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="question-input-methods">
                            <ul class="nav nav-pills mb-3" id="questionTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="manual-tab" data-bs-toggle="pill" data-bs-target="#manual-questions" 
                                            type="button" role="tab" aria-controls="manual-questions" aria-selected="true">
                                        <i class="fas fa-edit"></i> Nhập thủ công
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="excel-tab" data-bs-toggle="pill" data-bs-target="#excel-questions" 
                                            type="button" role="tab" aria-controls="excel-questions" aria-selected="false">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="stat-card">
                                                        ...
                                                        <div class="stat-content">
                                                            <div class="stat-value" id="statsDuration">60</div>
        ...
        <!-- Custom JS -->
        <script src="${pageContext.request.contextPath}/assets/js/teacher_js/createTest.js"></script>
    </body>
</html>