...
<div class="topbar">
  ...
  <nav class="nav">
    ...
    <% String currentUserId = (String) request.getAttribute("userId"); if
    (currentUserId == null) { currentUserId = (String)
    session.getAttribute("userId"); } if (currentUserId != null) {%>
    <a
    ...
    <div class="account-dropdown">
      <div class="avatar" onclick="toggleDropdown()">
        <%
        if (currentUser == null) { currentUser = (UserAccount)
        session.getAttribute("user"); } String avatarUrl = null; if (currentUser
        != null) { avatarUrl = currentUser.getProfilePicture(); } if (avatarUrl
        == null || avatarUrl.isEmpty()) { avatarUrl = request.getContextPath() +
        "/assets/img/avatar.png"; } else if (!avatarUrl.matches("^https?://.*"))
